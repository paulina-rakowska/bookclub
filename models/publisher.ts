...
PublisherSchema.statics.getPublishers = async function(): Promise<PublisherI[]> {
    try {
...
PublisherSchema.statics.getPublisherById = async function(id: ID): Promise<PublisherI> {
    try {
...
PublisherSchema.statics.addPublisher = async function(name: string, description: string): Promise<PublisherI> {
...
const PublisherModel =
  (models.Publisher as PublisherModelType) || model<PublisherI, PublisherModelType>("Publisher", PublisherSchema);
